...
| 05/09 | Sab | 7:00 | **S** | 46e | Dal Turista al Contadino — 1° weekend | 05–06/09 | ⚠️ NON PROMOSSO 15/07: dati parziali (luogo e orari non specificati, fonte singola non confermata) — promuoverla a feed ora rischierebbe di pubblicare un post con buchi. **Confermato STORIA da Michele il 23/07** (il feed pronto avrebbe luogo/ora vuoti = post con buchi; la storia basta). Da rivalutare a ridosso: se emergono luogo/ora veri, promuovere a feed. 🔴 **17/08: la fonte diretta usc.sm, ricontrollata due volte, mostra oggi una sola tappa (12-13/09)** — Michele ha premuto ✅ sul pulsante Telegram ma la riga resta sospesa (non passata a grafica) finché non si chiarisce con lui (master riga 59) |
